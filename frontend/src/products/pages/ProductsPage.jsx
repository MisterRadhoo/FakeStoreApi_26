...
import ProductCategoryFilter from "../components/ProductCategoryFilter.jsx";
import ProductBrandFilter from "../components/ProductBrandFilter.jsx";
...
const ProductPage = () => {
    ...
    return (
        <main className="pixel-font min-h-screen bg-[#fff1b8] px-6 py-16 text-[#030712] dark:bg-[#111827] dark:text-white">
            <section className="mx-auto w-full max-w-7xl border-4 border-[#030712] bg-white p-8 shadow-[12px_12px_0_#030712] dark:border-white dark:bg-[#1f2937] dark:shadow-[12px_12px_0_#ffffff]">
