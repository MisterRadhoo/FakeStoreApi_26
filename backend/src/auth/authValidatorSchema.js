...
const zAuthRegisterSchema = z.strictObject({
    ...
    confirmPassword: z.string("confirmPassword is required!").min(8, "At least 8 characters").max(45, "At most 45 characters"),
    fullName: z.string().trim().min(3, "At least 3 characters").max(60, "At most 60 characters").optional(),
